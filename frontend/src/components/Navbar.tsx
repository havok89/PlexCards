...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="bg-dark-900 border-b border-gray-800 sticky top-0 z-40 px-3 sm:px-6 py-2.5 sm:py-3.5">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-2 sm:gap-4">
        ...
        <div className="flex items-center gap-3 sm:gap-4 shrink-0">
          ...
          <div className="flex items-center bg-dark-950 p-1 rounded-xl border border-gray-800 shrink-0">
            <button
        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          <div className="relative">
            ...
            <input
              ...
              className="bg-dark-800 border border-gray-700 rounded-lg pl-8 sm:pl-9 pr-3 sm:pr-4 py-1.5 sm:py-2 text-xs sm:text-sm focus:outline-none focus:border-brand-500 w-32 sm:w-44 md:w-56 text-white placeholder-gray-500 transition-all"
            />
          </div>
